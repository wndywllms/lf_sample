...
def load_BH():
    ...
    return logp_BH, rho_AGN_BH, [rho_AGN_BH_erru, rho_AGN_BH_errl], rho_SF_BH, [rho_SF_BH_erru, rho_SF_BH_errl], rho_L_BH, [rho_L_BH_erru, rho_L_BH_errl], rho_H_BH, [rho_H_BH_erru, rho_H_BH_errl], rho_A_BH, [rho_A_BH_erru, rho_A_BH_errl]


def load_B2005():
    # load Best & Heckman LF
    B2005LF = load_fits('best2005LF.fits')
    logPlow = B2005LF.Plow
    logPhigh = B2005LF.Phigh
    logp_B2005 = (logPlow+logPhigh)/2.
    log_rho_AGN_B2005 = B2005LF.AGN_log_rho
    log_rho_AGN_B2005_erru = B2005LF.AGN_err_up
    log_rho_AGN_B2005_errl = B2005LF.AGN_err_low

    log_rho_SF_B2005 = B2005LF.SF_log_rho
    log_rho_SF_B2005_erru = B2005LF.SF_err_up
    log_rho_SF_B2005_errl = B2005LF.SF_err_low

    log_rho_A_B2005 = B2005LF.A_log_rho
    log_rho_A_B2005_erru = B2005LF.A_err_up
    log_rho_A_B2005_errl = B2005LF.A_err_low


    rho_AGN_B2005 = 10**log_rho_AGN_B2005
    rho_AGN_B2005_erru = 10**(log_rho_AGN_B2005+log_rho_AGN_B2005_erru) - 10**(log_rho_AGN_B2005)
    rho_AGN_B2005_errl = 10**(log_rho_AGN_B2005) - 10**(log_rho_AGN_B2005-log_rho_AGN_B2005_errl)

    rho_SF_B2005 = 10**log_rho_SF_B2005
    rho_SF_B2005_erru = 10**(log_rho_SF_B2005+log_rho_SF_B2005_erru) - 10**(log_rho_SF_B2005)
    rho_SF_B2005_errl = 10**(log_rho_SF_B2005) - 10**(log_rho_SF_B2005-log_rho_SF_B2005_errl)

    rho_A_B2005 = 10**log_rho_A_B2005
    rho_A_B2005_erru = 10**(log_rho_A_B2005+log_rho_A_B2005_erru) - 10**(log_rho_A_B2005)
    rho_A_B2005_errl = 10**(log_rho_A_B2005) - 10**(log_rho_A_B2005-log_rho_A_B2005_errl)

    return logp_B2005, rho_AGN_B2005, [rho_AGN_B2005_erru, rho_AGN_B2005_errl], rho_SF_B2005, [rho_SF_B2005_erru, rho_SF_B2005_errl], rho_A_B2005, [rho_A_B2005_erru, rho_A_B2005_errl]
